...
public:
   ...
   //--------------------------------------------------------------------
   void SetArmor(int equipment, int rarity) { armor = equipment; 
      armorRarity = rarity; collectedWeaponArmor = true; }

   //--------------------------------------------------------------------
   // sets the weapon damage amount the player has.
   //--------------------------------------------------------------------
   void SetDamage(int equipment, int rarity) { attackDamage = equipment; 
      weaponRarity = rarity; collectedWeaponArmor = true; }
   ...
   //--------------------------------------------------------------------
   // Returns true if a flashlight powerup just expired, false otherwise
   //--------------------------------------------------------------------
   bool FlashlightJustExpired();
   ...
   //--------------------------------------------------------------------
   // Returns true if a key was just collected, false otherwise
   //--------------------------------------------------------------------
   bool KeyJustCollected();
