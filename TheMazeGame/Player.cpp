...
Player::Player(int size):Character(size)
{
   ...
   flashlightExpired = false;
   collectedWeaponArmor = false;
   keyJustCollected = false;
}
...
bool Player::FlashlightJustExpired()
{
   if (flashlightExpired)
   {
      flashlightExpired = false;
      return true;
   }
