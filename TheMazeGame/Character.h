...
// Purpose: Contains code used to create and manipulate instances of any
//          character.
//-----------------------------------------------------------------------
...
public:
   ...
   //--------------------------------------------------------------------
   // Returns true if a health powerup was just collected, false
   // otherwise.
   //--------------------------------------------------------------------
   bool HealthJustCollected();
   ...
   //--------------------------------------------------------------------
   // Sets whether or not a character is currently straffing
   //--------------------------------------------------------------------
